...
table.insert(BanditClan.PrivateMilitia.Melee, BanditCompatibility.GetLegacyItem("Base.Machete"))
table.insert(BanditClan.PrivateMilitia.Melee, BanditCompatibility.GetLegacyItem("Base.HuntingKnife"))
