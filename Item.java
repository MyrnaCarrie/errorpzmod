...
public final class Item extends GameEntityScript {
   ...
   public void Load(String var1, String var2) throws Exception {
      ...
      for(ScriptParser.BlockElement var5 : var3.elements) {
         if (var5.asValue() != null) {
            ...
            ScriptParser.Block var14 = var5.asBlock();
            if (var14.type != null && var14.type.equalsIgnoreCase("component")) {
               this.LoadComponentBlock(var14);
            }
         }
      }
      ...
      if (!StringUtils.isNullOrWhitespace(this.replaceInPrimaryHand)) {
         String[] var12 = this.replaceInPrimaryHand.trim().split("\\s+");
         if (var12.length == 2) {
            this.replacePrimaryHand = new ItemReplacement();
            this.replacePrimaryHand.clothingItemName = var12[0].trim();
            this.replacePrimaryHand.maskVariableValue = var12[1].trim();
            this.replacePrimaryHand.maskVariableName = "RightHandMask";
         }
      }

      if (!StringUtils.isNullOrWhitespace(this.replaceInSecondHand)) {
         String[] var13 = this.replaceInSecondHand.trim().split("\\s+");
         if (var13.length == 2) {
            this.replaceSecondHand = new ItemReplacement();
            this.replaceSecondHand.clothingItemName = var13[0].trim();
            this.replaceSecondHand.maskVariableValue = var13[1].trim();
   ...
   public InventoryItem InstanceItem(String var1, boolean var2) {
      ...
      if (this.type == Item.Type.Key) {
         ...
         if (!this.PaletteChoices.isEmpty() || var1 != null) {
            int var6 = Rand.Next(this.PaletteChoices.size());
            var5 = (String)this.PaletteChoices.get(var6);
            if (var1 != null) {
               var5 = var1;
            }

            String var10000 = var5.replace(this.PalettesStart, "");
            var11 = "_" + var10000;
         }
         ...
         AlarmClockClothing var21 = (AlarmClockClothing)var3;
         var21.setTemperature(this.Temperature);
         var21.setInsulation(this.insulation);
         var21.setConditionLowerChance(this.ConditionLowerChance);
         var21.setStompPower(this.stompPower);
         var21.setRunSpeedModifier(this.runSpeedModifier);
         var21.setCombatSpeedModifier(this.combatSpeedModifier);
         var21.setRemoveOnBroken(this.removeOnBroken);
         var21.setCanHaveHoles(this.canHaveHoles);
         var21.setWeightWet(this.WeightWet);
         var21.setBiteDefense(this.biteDefense);
         var21.setBulletDefense(this.bulletDefense);
         var21.setNeckProtectionModifier(this.neckProtectionModifier);
         var21.setScratchDefense(this.scratchDefense);
         var21.setChanceToFall(this.chanceToFall);
         var21.setWindresistance(this.windresist);
         var21.setWaterResistance(this.waterresist);
         var21.setAlarmSound(this.AlarmSound);
         var21.setSoundRadius(this.SoundRadius);
      } else if (this.type == Item.Type.Weapon) {
         var3 = new HandWeapon(this.getModule().name, this.DisplayName, this.name, this);
         HandWeapon var12 = (HandWeapon)var3;
         ...
         this.AimingMod = var12.getAimingMod();
         ...
         var12.setMinSightRange(this.minSightRange);
         var12.setMaxSightRange(this.maxSightRange);
         ...
         var12.setExplosionDuration(this.explosionDuration);
         ...
         var12.setWeaponSpritesByIndex(this.weaponSpritesByIndex);
         var12.setProjectileCount(this.ProjectileCount);
         var12.setProjectileSpread(this.projectileSpread);
         var12.setProjectileWeightCenter(this.projectileWeightCenter);
         ...
         String var19 = null;
         if (!this.PaletteChoices.isEmpty() || var1 != null) {
            int var22 = Rand.Next(this.PaletteChoices.size());
            var19 = (String)this.PaletteChoices.get(var22);
            if (var1 != null) {
               var19 = var1;
            }

            String var25 = var19.replace(this.PalettesStart, "");
            var13 = "_" + var25;
         }

         var3 = new Clothing(this.getModule().name, this.DisplayName, this.name, "Item_" + this.Icon.replace(".png", "") + var13, var19, this.SpriteName);
         Clothing var23 = (Clothing)var3;
         var23.setTemperature(this.Temperature);
         var23.setInsulation(this.insulation);
         var23.setConditionLowerChance(this.ConditionLowerChance);
         var23.setStompPower(this.stompPower);
         var23.setRunSpeedModifier(this.runSpeedModifier);
         var23.setCombatSpeedModifier(this.combatSpeedModifier);
         var23.setRemoveOnBroken(this.removeOnBroken);
         var23.setCanHaveHoles(this.canHaveHoles);
         var23.setWeightWet(this.WeightWet);
         var23.setBiteDefense(this.biteDefense);
         var23.setBulletDefense(this.bulletDefense);
         var23.setNeckProtectionModifier(this.neckProtectionModifier);
         var23.setScratchDefense(this.scratchDefense);
         var23.setChanceToFall(this.chanceToFall);
         var23.setWindresistance(this.windresist);
         var23.setWaterResistance(this.waterresist);
      } else if (this.type == Item.Type.Drainable) {
         var3 = new DrainableComboItem(this.getModule().name, this.DisplayName, this.name, this);
         DrainableComboItem var14 = (DrainableComboItem)var3;
         ...
         var14.setReplaceOnCooked(this.ReplaceOnCooked);
         var14.setMinutesToCook((float)this.MinutesToCook);
         var14.setOnCooked(this.OnCooked);
         var14.setCanConsolidate(!this.cantBeConsolided);
         var14.setWeightEmpty(this.WeightEmpty);
         var14.setOnEat(this.onEat);
      } else if (this.type == Item.Type.Radio) {
         var3 = new Radio(this.getModule().name, this.DisplayName, this.name, "Item_" + this.Icon);
         Radio var15 = (Radio)var3;
         var15.setCanBeEquipped(this.CanBeEquipped);
         DeviceData var20 = var15.getDeviceData();
         if (var20 != null) {
            if (this.DisplayName != null) {
               var20.setDeviceName(this.DisplayName);
            }

            var20.setIsTwoWay(this.twoWay);
            var20.setTransmitRange(this.transmitRange);
            var20.setMicRange(this.micRange);
            var20.setBaseVolumeRange(this.baseVolumeRange);
            var20.setIsPortable(this.isPortable);
            var20.setIsTelevision(this.isTelevision);
            var20.setMinChannelRange(this.minChannel);
            var20.setMaxChannelRange(this.maxChannel);
            var20.setIsBatteryPowered(this.usesBattery);
            var20.setIsHighTier(this.isHighTier);
            var20.setUseDelta(this.UseDelta);
            var20.setMediaType(this.acceptMediaType);
            var20.setNoTransmit(this.noTransmit);
            var20.generatePresets();
            var20.setRandomChannel();
         }

         if (!StringUtils.isNullOrWhitespace(this.worldObjectSprite) && !var15.ReadFromWorldSprite(this.worldObjectSprite)) {
            String var26 = this.moduleDotType != null ? this.moduleDotType : "unknown";
            DebugLog.log("Item -> Radio item = " + var26);
         }
      } else if (this.type == Item.Type.Moveable) {
         var3 = new Moveable(this.getModule().name, this.DisplayName, this.name, this);
         Moveable var16 = (Moveable)var3;
         var16.ReadFromWorldSprite(this.worldObjectSprite);
         this.ActualWeight = var16.getActualWeight();
      } else if (this.type == Item.Type.Map) {
         MapItem var17 = new MapItem(this.getModule().name, this.DisplayName, this.name, this);
         if (StringUtils.isNullOrWhitespace(this.map)) {
            var17.setMapID(MapDefinitions.getInstance().pickRandom());
         } else {
            var17.setMapID(this.map);
         }
      ...
      Thread var24 = Thread.currentThread();
      if ((var24 == GameWindow.GameThread || var24 == GameLoadingState.loader || var24 == GameServer.MainThread) && !((InventoryItem)var3).isInitialised()) {
   ...
   public void DoParam(String var1, String var2) {
      try {
         ...
         if (var3 != null) {
         ...
         } else if (var1.trim().equalsIgnoreCase("Palettes")) {
            ...
            this.SwingAnim = var2;
         } else if (var1.trim().equalsIgnoreCase("Icon")) {
            this.Icon = var2;
            ...
            if (this.type == Item.Type.Food) {
               ...
               String var36 = this.WorldTextureName.replace(".png", "Rotten.png");
               if (var16 == null) {
                  var16 = Texture.trygetTexture(this.ItemName + "Spoiled");
                  var36 = var36.replace("Rotten.png", "Spoiled.png");
               }

               if (var16 == null) {
                  var16 = Texture.trygetTexture(this.ItemName + "_Rotten");
                  var36 = var36.replace("Rotten.png", "_Rotten.png");
               }

               this.SpecialWorldTextureNames.add(var36);
               ...
               String var7 = this.WorldTextureName.replace(".png", "Overdone.png");
               if (var6 == null) {
         ...
         } else if (var1.trim().equalsIgnoreCase("ReplaceOnUseOn")) {
            this.ReplaceOnUseOn = var2;
            if (var2.contains("-")) {
               String[] var17 = var2.split("-");
               String var37 = var17[0].trim();
               String var52 = var17[1].trim();
               if (!var37.isEmpty() && !var52.isEmpty()) {
                  if (this.ReplaceTypesMap == null) {
                     this.ReplaceTypesMap = new HashMap();
                  }

                  this.ReplaceTypesMap.put(var37, var52);
               }
            }
         } else if (var1.trim().equalsIgnoreCase("ReplaceTypes")) {
            this.ReplaceTypes = var2;
            String[] var18 = var2.split(";");

            for(String var8 : var18) {
            ...
            String[] var19 = var2.split(";");

            for(int var39 = 0; var39 < var19.length; ++var39) {
               this.clothingItemExtra.add(var19[var39]);
            }
            ...
            String[] var20 = var2.split("\\s+");
            if (var20.length >= 2 && var20.length <= 4) {
               ModelWeaponPart var40 = null;

               for(int var54 = 0; var54 < this.modelWeaponPart.size(); ++var54) {
                  ModelWeaponPart var59 = (ModelWeaponPart)this.modelWeaponPart.get(var54);
                  if (var59.partType.equals(var20[0])) {
                     var40 = var59;
                     break;
                  }
               }
               ...
               if (var40 == null) {
                  var40 = new ModelWeaponPart();
               }

               var40.partType = var20[0];
               var40.modelName = var20[1];
               var40.attachmentNameSelf = var20.length > 2 ? var20[2] : null;
               var40.attachmentParent = var20.length > 3 ? var20[3] : null;
               if (!var40.partType.contains(".")) {
                  var40.partType = this.getModule().name + "." + var40.partType;
               }

               if (!var40.modelName.contains(".")) {
                  var40.modelName = this.getModule().name + "." + var40.modelName;
               }

               if ("none".equalsIgnoreCase(var40.attachmentNameSelf)) {
                  var40.attachmentNameSelf = null;
               }

               if ("none".equalsIgnoreCase(var40.attachmentParent)) {
                  var40.attachmentParent = null;
               }

               this.modelWeaponPart.add(var40);
            }
            ...
            for(int var41 = 0; var41 < var21.length; ++var41) {
               this.clothingItemExtraOption.add(var21[var41]);
            }
            ...
            for(int var42 = 0; var42 < var22.length; ++var42) {
               this.weaponSpritesByIndex.add(var22[var42].trim());
            }
            ...
            String[] var23 = var2.split(";");

            for(int var43 = 0; var43 < var23.length; ++var43) {
               this.Categories.add(var23[var43].trim());
            }
         } else if (var1.trim().equalsIgnoreCase("Tags")) {
            String[] var24 = var2.split(";");

            for(int var44 = 0; var44 < var24.length; ++var44) {
               this.Tags.add(var24[var44].trim());
            }
            ...
            int var26 = Integer.parseInt(var2.trim());
            if ((float)var26 > 50.0F - this.ActualWeight) {
               var26 = (int)(50.0F - this.ActualWeight);
            }
            ...
            for(int var45 = 0; var45 < var27.length; ++var45) {
               String var55 = var27[var45].trim();
               this.teachedRecipes.add(var55);
               if (Translator.debug) {
                  Translator.getRecipeName(var55);
               }
            }
            ...
            for(int var46 = 0; var46 < var28.length; ++var46) {
               this.mountOn.add(var28[var46].trim());
            }
            ...
            String[] var47 = var2.split(";");

            for(int var56 = 0; var56 < var47.length; ++var56) {
               this.evolvedRecipe.add(var29[var56].trim());
            }

            for(int var57 = 0; var57 < var29.length; ++var57) {
               String var60 = var29[var57];
               Object var61 = null;
               int var63 = 0;
               boolean var64 = false;
               String var62;
               if (!var60.contains(":")) {
                  ...
                  var62 = var60.split(":")[0];
                  String var65 = var60.split(":")[1];
                  if (!var65.contains("|")) {
                     var63 = Integer.parseInt(var60.split(":")[1]);
                  } else {
                     String[] var12 = var65.split("\\|");
                     ...
                     var63 = Integer.parseInt(var12[0]);
                  }
               }

               if (var62.equals("RicePot") || var62.equals("RicePan")) {
                  var62 = "Rice";
               }

               if (var62.equals("PastaPot") || var62.equals("PastaPan")) {
                  var62 = "Pasta";
               }

               if (var62.equals("Roasted Vegetables")) {
                  var62 = "Stir fry";
               }

               ItemRecipe var66 = new ItemRecipe(this.name, this.getModule().getName(), var63);
               var66.cooked = var64;
               this.itemRecipeMap.put(var62, var66);
            }
            ...
            String[] var30 = var2.split(";");

            for(int var48 = 0; var48 < var30.length; ++var48) {
               this.IconsForTexture.add(var30[var48].trim());
            }
         } else if (var1.trim().equalsIgnoreCase("BloodLocation")) {
            this.bloodClothingType = new ArrayList();
            String[] var31 = var2.split(";");

            for(int var49 = 0; var49 < var31.length; ++var49) {
               this.bloodClothingType.add(BloodClothingType.fromString(var31[var49].trim()));
            }
            ...
            if (var1.trim().equalsIgnoreCase("SoundParameter")) {
               String[] var32 = var2.split("\\s+");
               if (this.soundParameterMap == null) {
                  this.soundParameterMap = new HashMap();
               }

               this.soundParameterMap.put(var32[0].trim(), var32[1].trim());
               ...
               String[] var33 = var2.split(";");

               for(int var50 = 0; var50 < var33.length; ++var50) {
                  this.staticModelsByIndex.add(var33[var50].trim());
               }
            } else if (var1.trim().equalsIgnoreCase("worldStaticModelsByIndex")) {
               this.worldStaticModelsByIndex = new ArrayList();
               String[] var34 = var2.split(";");

               for(int var51 = 0; var51 < var34.length; ++var51) {
                  this.worldStaticModelsByIndex.add(var34[var51].trim());
               }
               ...
               try {
                  Double var35 = Double.parseDouble(var2.trim());
                  this.DefaultModData.rawset(var1.trim(), var35);
   ...
   public void OnScriptsLoaded(ScriptLoadMode var1) throws Exception {
      ...
      for(Map.Entry var4 : this.itemRecipeMap.entrySet()) {
         boolean var5 = false;
         ...
         if (!var5) {
            ...
            String var10002 = (String)var4.getKey();
      ...
      if (this.itemConfigKey != null) {
         ...
         if (var9 == null) {
            String var10 = this.getItemConfigKey();
            throw new Exception("Cannot set item config '" + var10 + "' to item: " + this.getFullName());
         }
   ...
   public void resolveItemTypes() {
      ...
      if (this.ReplaceTypesMap != null) {
         for(String var6 : this.ReplaceTypesMap.keySet()) {
            String var3 = (String)this.ReplaceTypesMap.get(var6);
            this.ReplaceTypesMap.replace(var6, ScriptManager.instance.resolveItemType(this.getModule(), var3));
         }
      }
