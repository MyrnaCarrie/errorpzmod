...
--	changed all to 200 250 300 for faster speeds
    if v.down and v.dtprocdown>200 then
        v:onPressDown();
        v.timedownproc = t
    elseif v.down and v.dtdown>250 and v.dtprocdown>110 then
        v:onPressDown();
        v.timedownproc = t
    elseif v.down and v.dtdown>350 and v.dtprocdown>50 then
        v:onPressDown();
        v.timedownproc = t
    ...
    if v.up and v.dtprocup>200 then
        v:onPressUp();
        v.timeupproc = t
    elseif v.up and v.dtup>250 and v.dtprocup>110 then
        v:onPressUp();
        v.timeupproc = t
    elseif v.up and v.dtup>350 and v.dtprocup>50 then
        v:onPressUp();
        v.timeupproc = t
    ...
    if v.left and v.dtprocleft > 200 then
        v:onPressLeft()
        v.timeleftproc = t
    elseif v.left and v.dtleft > 250 and v.dtprocleft > 110 then
        v:onPressLeft()
        v.timeleftproc = t
    elseif v.left and v.dtleft > 350 and v.dtprocleft > 50 then
        v:onPressLeft()
        v.timeleftproc = t
    ...
    if v.right and v.dtprocright > 200 then
        v:onPressRight()
        v.timerightproc = t
    elseif v.right and v.dtright > 250 and v.dtprocright > 110 then
        v:onPressRight()
        v.timerightproc = t
    elseif v.right and v.dtright > 350 and v.dtprocright > 50 then
        v:onPressRight()
        v.timerightproc = t
